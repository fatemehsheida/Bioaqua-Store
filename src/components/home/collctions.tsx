...
const Collctions = () => {
 ...
 <div className="text-right mb-10 mx-auto">
          <h2 className="text-3xl font-medium text-gray-900 dark:text-slate-50">کالکشن ها</h2>
        </div>
        ...
        <div className="group transition-all duration-75 cursor-pointer">
          ...
          <button>
            <div className="flex items-center gap-2 sm:gap-3 px-2 sm:px-4 py-1 sm:py-2 text-base sm:text-lg font-medium">
              <div className="group-hover:scale-150 transition-transform duration-300 dark:text-slate-50">
                <GoChevronRight />
              </div>
              <h4 className='dark:text-slate-300'>ست های آرایشی</h4>
            </div>
          </button>
        </div>
        ...
        <div className="group transition-all duration-75 cursor-pointer">
          ...
          <button>
            <div className="flex items-center gap-2 sm:gap-3 px-2 sm:px-4 py-1 sm:py-2 text-base sm:text-lg font-medium">
              ...
              <h4 className='dark:text-slate-300'>پیشنهادات زیبایی</h4>
            </div>
          </button>
        </div>
        ...
        <div className="group transition-all duration-75 cursor-pointer">
          ...
          <button>
            <div className="flex items-center gap-2 sm:gap-3 px-2 sm:px-4 py-1 sm:py-2 text-base sm:text-lg font-medium">
              ...
              <h4 className='dark:text-slate-300'>مراقبت از پوست</h4>
            </div>
          </button>
        </div>
