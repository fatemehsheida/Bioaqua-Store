    ...
    return (
        <div> <QuantityBtn count={count} dec={dec} inc={inc} setCount={setCount} />
            <div className="w-[90%]  flex flex-col justify-center items-center gap-3 my-5">
                <AddToCart product={product} quantity={count} style={"w-full font-normal text-center bg-[#FFFFFF] my-1 text-DarkPurple text-sm rounded-lg py-2 ring-1 hover:ring-2 ring-DarkPurple "} />
