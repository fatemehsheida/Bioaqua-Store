    ...
    return (
        <div> <QuantityBtn count={count} dec={dec} inc={inc} setCount={setCount} />
            <div className="w-[90%]  flex flex-col justify-center items-center gap-3 my-5">
                <AddToCart product={product} quantity={count} style={"w-full font-normal text-center bg-[#FFFFFF] text-[#2E2A39] text-sm rounded-lg py-2 border hover:border-2 border-[#2E2A39] "} />
