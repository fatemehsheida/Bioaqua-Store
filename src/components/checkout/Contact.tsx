...
const Contact = () => {
    return (
        <div className='w-full'>
            <div className='w-full flex justify-between text-JetBlack'>
                <span className=' font-normal text-base'>تماس بگیرید</span>
                <Link href="/login" >
                    <span className='underline text-xs text-SilverGray dark:text-white/80'>وارد شوید</span>
                </Link>
            </div>
            <div className='w-full flex flex-col'>
                ...
                <div className='text-xs font-normal flex justify-end px-1 items-center gap-2'>
                    ...
                    <input type="checkbox" name="offers" id="offers" className='accent-Flint' />
                </div>
            </div>
        </div>
    )
