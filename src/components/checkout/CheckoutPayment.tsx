    ...
    return (
       ...
       border border-slate-300 checked:border-slate-300 transition-all" id="paypal" />
         ...
         transition-opacity duration-200 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <div className='flex '>
                        <label className="ml-2 text-slate-600 cursor-pointer text-base px-2 dark:text-white" htmlFor="paypal">paypal</label>
      ...
      border border-slate-300 checked:border-slate-300 transition-all" id="otherpay" />
        ...
        transition-opacity duration-200 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <label className="ml-2 text-slate-600 cursor-pointer text-base px-2 dark:text-white" htmlFor="otherpay">روش های پرداخت دیگر</label>
                </div>
            </div>
