         ...
         ring-gray-500/40 rounded-lg mt-8 pt-4 hover:cursor-context-menu'>
          ...
          <div className=' items-start flex flex-col justify-center py-2  gap-2 w-72'>
            ...
            <div className='flex gap-4'>
              ...
              <span className='text-sm underline cursor-pointer hover:text-Iron/90'>{address.postalCode}</span>
            </div>
            <div className='flex gap-4'>
              <span className='text-sm font-semibold cursor-pointer'>شماره تماس</span>
              <span className='text-sm underline cursor-pointer hover:text-Iron/90'>09152684253</span>
            </div>
          </div>
        </div>
      </div>
