    ...
    <div className="px-8 pb-12 pt-2">
      <div className="justify-between">
        <div className=" group ">
          ...
          <AddToCart product={product} quantity={1} style={" w-full bg-white dark:bg-Abyss/85 ring-1 ring-DarkPurple dark:ring-slate-400/80 hover:ring-2 px-4 py-3 rounded-lg dark:text-Linen dark:text-slate-200 text-sm font-normal"} />
        </div>
      </div>
    </div >
  );
